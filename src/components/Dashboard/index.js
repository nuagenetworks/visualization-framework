...
const mapStateToProps = (state, ownProps) => ({
    configuration: state.dashboards.getIn([DashboardActionKeyStore.KEY_STORE_DASHBOARDS, ownProps.params.dashboardID, DashboardActionKeyStore.KEY_STORE_DATA]),
    fetching: state.dashboards.getIn([DashboardActionKeyStore.KEY_STORE_DASHBOARDS, ownProps.params.dashboardID, DashboardActionKeyStore.KEY_STORE_IS_FETCHING]),
    error: state.dashboards.getIn([DashboardActionKeyStore.KEY_STORE_DASHBOARDS, ownProps.params.dashboardID, DashboardActionKeyStore.KEY_STORE_ERROR]),
});
