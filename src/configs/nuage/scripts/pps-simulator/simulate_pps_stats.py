...
data = { "VRFId":"1946293155" ,  "SrcNSG":"44.32.45.181" , "DestNSG":"121.245.72.101" , "SourceIP":"20.0.0.4" ,  "SourcePort" : 15125 ,  "DestIP":"20.0.6.4" ,  "DestinationPort" : 53 , "AppGroupId" : "60fe3a70-4563-4292-bbbd-37a480e43ff7" ,  "AppId" :  "34762b19-30c5-483a-ab69-e531abb4b3c8" ,  "L7Classification" : "DNS" ,  "Proto" :  "UDP" ,  "SrcUplinkIndex" :  1 ,  "srcUplinkRole" :  "primary" ,  "DestUplinkIndex" : 1 ,  "dstUplinkRole" : "primary" , "SrcVportId": "6bf86674-b2aa-4477-a73c-2d18c7316197" , "DestVportId":  "",  "Egress Bytes" :  0 ,  "Egress Pkts" :  0 ,  "Ingress Bytes" :  7500 ,  "Ingress Pkts" :  125 }
                ...
                for s_nsg_ind, src_nsg in enumerate(nsgs):
                    if s_nsg_ind % 2:
                        ...
                        for appgrp in app_grps:
                            applist = aapgrp["app_list"]
                            app = random.choice(applist)
                            app_grp_id = appgrp["appgrp_id"]
    ...
    with open('/var/log/flowstats_new.log', 'w') as flowstats:
        ...
        while timestamp != endTime:
            ...
            for flow_entry in pre_flows:
                ...
                flow_record["EgressMB"] = float(inbytes)/1048576
