...
- **selectColumnOption** (Boolean) To show columns dropdown option to show/hide columns from the table - default is `false`. Set `display: false` in column array to hide column by default.
